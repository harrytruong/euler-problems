...
const EULER_SOLUTIONS = {
    1: function(){ // 1. Multiples of 3 and 5
    ...
    2: function(){ // 2. Even Fibonacci numbers
    ...
    3: function(){ // 3. Largest prime factor
    ...
    4: function(){ // 4. Largest palindrome product
    ...
    5: function(){ // 5. Smallest multiple
    ...
    6: function(){ // 6. Sum square difference
    ...
    7: function(){ // 7. 10001st prime
        ...
        return (primes[10000]); // 10001th
    },

    8: function(){ // 8. Largest product in a series
    ...
    9: function(){ // 9. Special Pythagorean triplet
        ...
        return (theOne[0] * theOne[1] * theOne[2]);
    },

    10: function(){ // 10. Summation of primes
        ...
        return (_.reduce(primes, function(m,n){ return n+m; }, 0));
    },

    11: function(){ // 11. Largest product in a grid
    ...
    12: function(){ // 12. Highly divisible triangular number
    ...
    13: function(){ // 13. Large sum
        ...
        return (String(sum).slice(0,11).replace(/\D/g,''));
    },

    14: function(){ // 14. Longest Collatz sequence
        ...
        return (longestChain.num);
    },

    15: function(){ // 15. Lattice paths
        ...
        // therefore..
        return (parseInt(mathjs.factorial(40)/(mathjs.factorial(20)*mathjs.factorial(20))));
    },

    16: function(){ // 16. Power digit sum
    ...
    17: function(){ // 17. Number letter counts
    ...
    18: function(){ // 18. Maximum path sum I
    ...
    19: function(){ // 19. Counting Sundays
    ...
    20: function(){ // 20. Factorial digit sum
    ...
    21: function(){ // 21. Amicable numbers
        ...
        return (sum / 2); // divide by two (numbers counted twice)
    },

    22: function(){ // 22. Names scores
        var alpha = 'abcdefghijklmnopqrstuvwxyz'.split('');

        return fetch('/p022_names.txt')
          .then(res => res.text())
          .then(data => {
    ...
    23: function(){ // 23. Non-abundant sums
    ...
    24: function(){ // 24. Lexicographic permutations
    ...
    25: function(){ // 25. 1000-digit Fibonacci number
    ...
    26: function(){ // 26. Reciprocal cycles
        ...
        // http://mathjsworld.wolfram.com/CyclicNumber.html
        //
        ...
        while ((prime = primes.pop()) &&
            ...
            // http://mathjsworld.wolfram.com/FullReptendPrime.html
    ...
    27: function(){ // 27. Quadratic primes
    ...
    28: function(){ // 28. Number spiral diagonals
    ...
    29: function(){ // 29. Distinct powers
        BigNumber.config({ POW_PRECISION: 0 });
        ...
        return (_.keys(terms).length);
    },

    30: function(){ // 30. Digit fifth powers
        ...
        // print sum
        return (_.reduce(sumOfPowerDigits, function(m, n){
            return m + n;
        }, 0));
    },

    31: function(){ // 31. Coin sums
        ...
        return (combineForTotal(coins, 200));
    },

    32: function(){ // 32. Pandigital products
    ...
    33: function(){ // 33. Digit cancelling fractions
    ...
    35: function(){ // 35. Circular primes
    ...
    36: function(){ // 36. Double-base palindromes
    ...
    37: function(){ // 37. Truncatable primes
    ...
    38: function(){ // 38. Pandigital multiples
    ...
    39: function(){ // 39. Integer right triangles
    ...
    40: function(){ // 40. Champernowne's constant
        ...
        var d = digits.split('');
        return (d[1e0] * d[1e1] * d[1e2] * d[1e3] * d[1e4] * d[1e5] * d[1e6]);
    },

    41: function(){ // 41. Pandigital prime
    ...
    42: function(){ // 42. Coded triangle numbers
    ...
    43: function(){ // 43. Sub-string divisibility
    ...
    44: function(){ // 44. Pentagon numbers
    ...
    45: function(){ // 45. Triangular, pentagonal, and hexagonal
    ...
    46: function(){ // 46. Goldbach's other conjecture
    ...
    47: function(){ // 47. Distinct primes factors
        var primes = generatePrimes(1e6)
    ...
    48: function(){ // 48. Self powers
        ...
        return (n.toFixed(0).slice(-10));
    },

    49: function(){ // 49. Prime permutations
        ...
        for (var i in targets){
            ...
            return (targets[i].join(''));
        }
    },

    50: function(){ // 50. Consecutive prime sum
    ...
    51: function(){ // 51. Prime digit replacements
        ...
        return (_.max(counts, function(c){return c.count; }).primes[0]);
    },

    52: function(){ // 52. Permuted multiples
    ...
    53: function(){ // 53. Combinatoric selections
    ...
    54: function(){ // 54. Poker hands
        ...
        fetch('/p054_poker.txt', function(data){
    ...
    55: function(){ // 55. Lychrel numbers
    ...
    56: function(){ // 56. Powerful digit sum
        BigNumber.config({ POW_PRECISION: 0 });
    ...
    57: function(){ // 57. Square root convergents
    ...
    58: function(){ // 58. Spiral primes
        ...
        generatePrimesHigh(5e8, function(primes){
            ...
            return (sideLength(depth));
        })

    },

    59: function(){ // 59. XOR decryption
        var alpha = 'abcdefghijklmnopqrstuvwxyz'.split('');
                ...
                for (var ii = 0; ii < alpha.length; ii++){
                    for (var iii = 0; iii < alpha.length; iii++){
                        ...
                        if (msg.indexOf(' ') !== -1 &&
                            ...
                            // print ASCII sum
                            return (_.reduce(msg.split(''), function(m, c){
...
export default EULER_SOLUTIONS;
